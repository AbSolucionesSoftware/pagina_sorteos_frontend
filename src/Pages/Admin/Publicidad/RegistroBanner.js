import { Button, Dialog, DialogActions, DialogContent, 
        DialogTitle, Grid, Slide, Typography } 
    ...
    return (
        <div>
            ...
            >
                ...
                <DialogActions>
                    <Button color='error' variant='contained' onClick={handleDrawerOpen}>Cancelar</Button>
                    <Button color='primary' variant='contained' onClick={subirImagen}>Guardar</Button>
                </DialogActions>
            </Dialog>
        </div>
    )
